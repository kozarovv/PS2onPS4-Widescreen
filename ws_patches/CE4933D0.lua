...
eeObj.WriteMem32(0x000C0038,0x0804B657)
...
eeObj.WriteMem32(0x000C0078,0x0804B663)
...
eeObj.WriteMem32(0x0012D954,0x08030000)

-- Jump to WORD patching routine
eeObj.WriteMem32(0x0012D984,0x08030010)
end
