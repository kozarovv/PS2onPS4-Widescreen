...
--comment=Widescreen Fix by PsxFan107 (NTSC-J by Arapapa)

-- Widescreen by nemesis2000
eeObj.WriteMem32(0x0014dba8,0x3c013fdd)
eeObj.WriteMem32(0x0014dbac,0x3421a523)

-- Widescreen Bug Fix
--c3080346 0000a5c7
eeObj.WriteMem32(0x0014f7c8,0x08030000)
eeObj.WriteMem32(0x000C0000,0x3C013F40)
eeObj.WriteMem32(0x000C0004,0x4481F000)
eeObj.WriteMem32(0x000C0008,0x461E2102)
eeObj.WriteMem32(0x000C000C,0x08053df4)
eeObj.WriteMem32(0x000C0010,0x460308C3)

-- Character Portraits Fix
--02a50146 240151c4
eeObj.WriteMem32(0x001bf6a0,0x0C030005)
