...
--comment=Widescreen Fix by PsxFan107

-- Widescreen by nemesis2000
eeObj.WriteMem32(0x0014D750,0x3C013FDD)
eeObj.WriteMem32(0x0014D754,0x3421A523)

-- Widescreen Bug Fix
eeObj.WriteMem32(0x0014F370,0x08030000)
eeObj.WriteMem32(0x000C0000,0x3C013F40)
eeObj.WriteMem32(0x000C0004,0x4481F000)
eeObj.WriteMem32(0x000C0008,0x461E2102)
eeObj.WriteMem32(0x000C000C,0x08053CDE)
eeObj.WriteMem32(0x000C0010,0x460308C3)

-- Character Portraits Fix
eeObj.WriteMem32(0x001BE808,0x0C030005)
